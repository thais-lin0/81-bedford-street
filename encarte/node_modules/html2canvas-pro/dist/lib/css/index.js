...
class CSSParsedDeclaration {
    constructor(context, declaration) {
        ...
        this.clipPath = parse(context, clip_path_1.clipPath, declaration.clipPath);
        ...
        this.writingMode = parse(context, writing_mode_1.writingMode, declaration.writingMode);
        ...
        this.imageRendering = parse(context, image_rendering_1.imageRendering, declaration.imageRendering);
    }
    isVisible() {
