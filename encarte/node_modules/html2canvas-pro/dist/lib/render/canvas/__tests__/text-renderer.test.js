...
describe('renderTextWithLetterSpacing', () => {
    ...
    it('should render CJK glyphs upright in vertical writing mode', () => {
        ...
        const renderer = new text_renderer_1.TextRenderer(deps);
        const bounds = new bounds_1.Bounds(100, 50, 24, 80);
        const text = new text_1.TextBounds('縦書', bounds);
        renderer.renderTextWithLetterSpacing(text, 4, 18, 1 /* WRITING_MODE.VERTICAL_RL */);
        (0, assert_1.deepStrictEqual)(fillCalls, [
            { text: '縦', x: 100, y: 68 },
            { text: '書', x: 100, y: 92 }
        ]);
        (0, assert_1.strictEqual)(baselineAtRender['縦'], 'ideographic');
        (0, assert_1.strictEqual)(baselineAtRender['書'], 'ideographic');
        (0, assert_1.strictEqual)(currentBaseline, 'alphabetic');
    });
    it('should rotate Latin glyphs in vertical writing mode', () => {
        ...
        const renderer = new text_renderer_1.TextRenderer(deps);
        const bounds = new bounds_1.Bounds(40, 10, 24, 60);
        const text = new text_1.TextBounds('AB', bounds);
        renderer.renderTextWithLetterSpacing(text, 2, 16, 1 /* WRITING_MODE.VERTICAL_RL */);
        (0, assert_1.deepStrictEqual)(fillCalls, [
            { text: 'A', x: 0, y: 0 },
            { text: 'B', x: 0, y: 0 }
        ]);
        (0, assert_1.deepStrictEqual)(operations, [
            'save',
            'translate:56,10',
            `rotate:${Math.PI / 2}`,
            'restore',
